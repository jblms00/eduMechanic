...
const currentUserId = $("body").data("admin-id");
...
function updateProfilePhoto() {
	$(document).on("change", "#fileToUpload", function () {
		...
		$.ajax({
			url: "../phpscripts/usr/update-profile-photo.php",
			type: "POST",
			data: formData,
			dataType: "json",
			processData: false,
...
function updatePersonalInformation() {
	$(document).on("submit", "#personalInfoForm", function (event) {
		...
		$.ajax({
			url: "../phpscripts/usr/update-personal-info.php",
			type: "POST",
			data: formData,
			dataType: "json",
			success: function (response) {
...
function updatePassword() {
	$(document).on("submit", "#userPasswordForm", function (event) {
		...
		$.ajax({
			url: "../phpscripts/usr/update-password.php",
			type: "POST",
			data: formData,
			dataType: "json",
			success: function (response) {
